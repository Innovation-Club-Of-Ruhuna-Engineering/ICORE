...
export class UpdateProjectInput extends PartialType(CreateProjectInput) {
    ...
    @Length(10, 500, { message: 'Project technical details must be between 10 and 500 characters' })
    details?: string
    ...
    @IsArray()
    @IsString({ each: true, message: 'Research papers must be an array of strings' })
    papers?: string[]
    ...
    @Length(10, 500, { message: 'Youtube URL must be between 12 and 100 characters' })
    youtubeURL?: string
    ...
    @Length(10, 500, { message: 'Github URL must be between 12 and 100 characters' })
    githubURL?: string
    ...
    @Length(10, 500, { message: 'Website URL must be between 12 and 100 characters' })
    websiteURL?: string
}
...
export class ProjectResponse {
  ...
  @ApiProperty({
    example: 'An IoT-based system for monitoring and automating agricultural processes',
    description: 'Short public description of the project'
  })
  about: string;

  @ApiProperty({
    example: 'Detailed technical description of the agricultural monitoring system...',
